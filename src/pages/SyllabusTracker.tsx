...
import { Target, CheckCircle, BarChart3, ArrowRight, BookOpen, Layers, Eye } from 'lucide-react';
...
const SyllabusTracker = () => {
  ...
  const softwareSchema = {
    ...
    "description": "Topic-wise syllabus tracker for competitive and government exams. Track your preparation progress visually.",
    "offers": {
      "@type": "Offer",
      "price": "0",
      "priceCurrency": "INR"
  ...
  return (
    <>
      <Helmet>
        <title>Syllabus Tracker – Track Exam Syllabus Topic-Wise | ExamTrakr</title>
        <meta 
          name="description" 
          content="ExamTrakr Syllabus Tracker helps you track exam syllabus topic-wise. Mark topics complete, see visual progress, never miss any topic. Best syllabus tracker app for competitive exams." 
        />
        <meta 
          name="keywords" 
          content="syllabus tracker, syllabus tracker app, topic wise syllabus tracker, exam syllabus tracker, syllabus tracking app, how to track exam syllabus, syllabus completion tracker, exam wise syllabus tracker app, best way to complete exam syllabus" 
        />
        <meta property="og:title" content="Syllabus Tracker – Track Exam Syllabus Topic-Wise | ExamTrakr" />
        <meta property="og:description" content="Track exam syllabus topic-wise with visual progress bars. Best syllabus tracker for competitive exams." />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="text-center max-w-4xl mx-auto">
                <h1 className="text-4xl sm:text-5xl font-bold text-foreground mb-6">
                  Syllabus Tracker – Track Every{' '}
                  <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
                    Topic You Study
                  </span>
                </h1>
                <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                  Wondering "how to track exam syllabus"? ExamTrakr's syllabus tracker lets you mark topics complete, see visual progress bars, and never forget what you studied. The best way to complete exam syllabus on time!
                </p>
          ...
          <section className="py-16 bg-background">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-6">
                Syllabus is Too Big – How to Manage?
              </h2>
              <p className="text-xl text-muted-foreground mb-8">
                Every student preparing for competitive exams faces this problem. The syllabus seems endless, you study but forget, and exam day comes with incomplete preparation. Sound familiar?
              </p>
          ...
          <section className="py-16 bg-accent/30">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <h2 className="text-3xl font-bold text-foreground mb-4">
                Syllabus Tracker for All Major Exams
              </h2>
              <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                ExamTrakr has topic-wise syllabus ready for 150+ competitive and government exams
              </p>
              
              <div className="flex flex-wrap justify-center gap-3">
                {['IBPS PO', 'SBI Clerk', 'SSC CGL', 'SSC CHSL', 'UPSC', 'Railway', 'CTET', 'JEE Main', 'NEET', 'GATE', 'CAT', 'CLAT'].map((exam, index) => (
